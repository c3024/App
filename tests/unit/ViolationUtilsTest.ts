...
const deletedTaxCodeViolation: TransactionViolation = {
...
describe('getViolationsOnyxData', () => {
    ...
    it('should not strip taxOutOfPolicy when transaction.taxCode is not a key on policy.taxRates.taxes', () => {
        ...
        const validTaxCode = 'tax_code_new';
        policy.tax = {trackingEnabled: true};
        policy.taxRates = {
            name: 'Taxes',
            defaultExternalID: validTaxCode,
            defaultValue: '5%',
            foreignTaxDefault: validTaxCode,
            taxes: {
                [validTaxCode]: {
                    name: 'hj',
                    value: '5',
        ...
        transactionViolations = [deletedTaxCodeViolation];
        ...
        expect(result.value).toContainEqual(deletedTaxCodeViolation);
    });
